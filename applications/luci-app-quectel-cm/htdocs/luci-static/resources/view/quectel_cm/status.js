...
function normalizeStatus(data) {
	return {
		...
		band_info: (data && data.band_info) || _('Unknown'),
		imei: (data && data.imei) || _('Unknown'),
		iccid: (data && data.iccid) || _('Unknown'),
		imsi: (data && data.imsi) || _('Unknown'),
		active_sim_slot: (data && data.active_sim_slot) || _('Unknown'),
		sim_slots_supported: (data && data.sim_slots_supported) || _('Unknown'),
		dsss_status: (data && data.dsss_status) || _('Unknown'),
		connected_sims: (data && data.connected_sims) || _('Unknown'),
...
return view.extend({
	...
	renderStatus: function(container, data) {
		dom.content(container, [
			...
			fieldRow(_('DSSS'), data.dsss_status),
			...
			fieldRow(_('IMEI'), data.imei),
			fieldRow(_('ICCID'), data.iccid),
			fieldRow(_('IMSI'), data.imsi),
			fieldRow(_('Network connected'), data.network_status),
			fieldRow(_('Network type'), data.network_type),
			fieldRow(_('Band'), data.band_info),
